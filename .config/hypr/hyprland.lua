...
hl.bind("ALT + SHIFT + Tab",          hl.dsp.window.cycle({ direction = "prev" }))
...
hl.bind("XF86MonBrightnessUp",   hl.dsp.exec_cmd("~/.config/hypr/scripts/brightness.sh raise"), { locked = true, repeating = true })
hl.bind("XF86MonBrightnessDown", hl.dsp.exec_cmd("~/.config/hypr/scripts/brightness.sh lower"), { locked = true, repeating = true })
